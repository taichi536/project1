...
- 年収がプロフィールに明記されており、以下の閾値を下回る → 必ずNG（情報が明確な場合は「迷う」余地なし）
...
【その他の判定基準】
- 社格: 上場企業・大手グループ・知名度ある企業はOK。無名の零細企業のみNG。NTT西日本・NTT東日本・NTTデータ等NTTグループ各社はOK。レバレジーズ（レバテック）・シフトはOK。判断は現職のみで行い、過去の在籍企業の社格でNGにしない。
