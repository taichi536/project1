...
【年齢別年収】※年収情報が不明な場合はOK扱い。明記されている場合のみ以下で判定
  ・20代: ${v('age20s', 400)}万円未満はNG（ポテンシャル採用のため職種は問わない）
  ・30〜35歳: ${v('age30to35', 550)}万円未満はNG、${v('age30to35', 550)}〜${v('age30to35', 550)+100}万円は要確認
  ・36〜39歳: ${v('age36to39', 650)}万円未満はNG、${v('age36to39', 650)}〜${v('age36to39', 650)+100}万円は要確認
  ・40〜42歳: ${v('age40to42', 800)}万円未満はNG、${v('age40to42', 800)}〜${v('age40to42', 800)+100}万円は要確認
  ・43〜45歳: ${v('age43to45', 1000)}万円未満はNG、${v('age43to45', 1000)}〜${v('age43to45', 1000)+150}万円は要確認
  ・46〜47歳: ${v('age46to47', 1000)}万円未満はNG、${v('age46to47', 1000)}〜${v('age46to47', 1000)+150}万円は要確認
