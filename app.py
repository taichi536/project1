...
if "auto_refresh" not in st.session_state:
    st.session_state["auto_refresh"] = _dash_cfg.get("auto_refresh", False)
if "auto_refresh_interval_idx" not in st.session_state:
    st.session_state["auto_refresh_interval_idx"] = _dash_cfg.get("auto_refresh_interval_idx", 1)

def _on_auto_refresh_change():
    _save_dash_config({
        "auto_refresh": st.session_state["auto_refresh"],
        "auto_refresh_interval_idx": st.session_state.get("auto_refresh_interval_idx", 1),
    })
