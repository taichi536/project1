...
function buildCriteriaText(criteria) {
  ...
  lines.push(`【年齢別年収】年収情報が不明な場合はOK扱い。明記されている場合のみ判定`);
  lines.push(`- 20代: ${iv('age20s', 400)}万円未満はNG`);
  lines.push(`- 30〜35歳: ${iv('age30to35', 550)}万円未満はNG、〜${iv('age30to35', 550)+100}万円は要確認`);
  lines.push(`- 36〜39歳: ${iv('age36to39', 650)}万円未満はNG、〜${iv('age36to39', 650)+100}万円は要確認`);
  lines.push(`- 40〜42歳: ${iv('age40to42', 800)}万円未満はNG、〜${iv('age40to42', 800)+100}万円は要確認`);
  lines.push(`- 43〜45歳: ${iv('age43to45', 1000)}万円未満はNG、〜${iv('age43to45', 1000)+150}万円は要確認`);
  lines.push(`- 46〜47歳: ${iv('age46to47', 1000)}万円未満はNG、〜${iv('age46to47', 1000)+150}万円は要確認`);
