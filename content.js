...
function buildCriteriaText(criteria) {
  ...
  lines.push(`- 20代: ${iv('age20s', 400)}万円以上`);
  lines.push(`- 30〜35歳: ${iv('age30to35', 550)}万円を大きく下回る場合NG`);
  lines.push(`- 36〜39歳: ${iv('age36to39', 650)}万円を大きく下回る場合NG`);
  lines.push(`- 40〜42歳: ${iv('age40to42', 800)}万円を大きく下回る場合NG`);
  lines.push(`- 43〜45歳: ${iv('age43to45', 1000)}万円を大きく下回る場合NG`);
  lines.push(`- 46〜47歳: ${iv('age46to47', 1000)}万円を大きく下回る場合NG`);
