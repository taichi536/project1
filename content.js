...
function buildCriteriaText(criteria, platform) {
  ...
  lines.push(`- 現在の勤務先が社格の低いベンチャー・スタートアップの場合は即NG。「社格の低いベンチャー」の定義：非上場・非外資で一般的な知名度がなく、メルカリ・SmartHR・freee・マネーフォワード・LayerX・Sansan等のメガベンチャー・著名スタートアップに該当しない無名の中小ベンチャー。有名上場企業・外資系・メガベンチャー・著名スタートアップに現在在籍中の人のみOK対象`);
  lines.push(`- 現職の会社の従業員数が500人以下の場合は即NG（設立年数は不問。従業員数がプロフィールに記載なく不明な場合はこのルールのみでNGにしない）`);
  lines.push(`- 現職の会社の設立（創業）から10年未満の新興企業の場合は即NG（従業員数は不問。設立年・創業年がプロフィールに記載なく不明な場合はこのルールのみでNGにしない）`);
