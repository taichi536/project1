...
function buildCriteriaText(criteria, platform) {
  ...
  lines.push(`- 46歳以上で文系職（コンサル・営業・マーケ・経営企画・人事・金融営業・研究職等）かつ財務・経理・FP&A・CFO・財務戦略等の職歴が一切ない場合は即NG（年収が高くても）`);
  lines.push(`- 46歳以上でITエンジニア系（ソフトウェア・インフラ・データエンジニア等）は即NG`);
  ...
  lines.push(`- 「ITエンジニア系」: ソフトウェア開発・インフラ・クラウド・システム構築・SE・データエンジニア等のIT技術職。DXコンサル・ITコンサル・PMO・システム営業・IT営業・データアナリスト等のIT関連職も含む`);
  lines.push(`- 「文系職」: コンサル・営業・マーケ・経営企画・財務・人事・その他ビジネス職（IT関連を除く）。研究職（基礎研究・応用研究・バイオ・化学・材料等）も文系職として扱うこと`);
