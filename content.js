...
function buildCriteriaText(criteria, platform) {
  ...
  lines.push(`- 46歳以上でIT・理系・技術職（ソフトウェアエンジニア・インフラ・クラウド・SE・データサイエンティスト・データアナリスト・DXコンサル・PMO・研究職等）は即NG`);
  ...
  lines.push(`- 「ITエンジニア系（IT・理系・技術職）」: ソフトウェアエンジニア・SE・インフラ・クラウド・システム構築・データエンジニア・データサイエンティスト・データアナリスト・DXコンサル・ITコンサル・PMO・研究職（バイオ・化学・材料等）等`);
