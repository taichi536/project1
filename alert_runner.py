...
def main():
    ...
    def run_once():
        ...
        # 休場日チェック（暗号資産・ペーパートレード系は24/7動くのでスキップ不要）
        crypto_modes = ("watchlist", "momentum", "crypto_ma", "crypto_multi", "paper", "paper_summary", "paper_reset")
        if args.mode not in crypto_modes and not is_trading_day():
